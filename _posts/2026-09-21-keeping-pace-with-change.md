...
<figure>
  <img src="/assets/img/2026/09/virtual-vault-home-page-before.png" alt="Figure 1. The old user interface for Virtual Vault, which contains search boxes for each record type and uses custom styles based on Bootstrap." />
  <figcaption>Figure 1. The old user interface for Virtual Vault, which contains search boxes for each record type and uses custom styles based on Bootstrap.</figcaption>
</figure>
