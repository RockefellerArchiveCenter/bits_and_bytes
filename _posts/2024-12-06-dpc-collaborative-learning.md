---
title: "The Digital Processing Collaborative: Laying the Groundwork for Collaborative Learning"
...
- What types of digital records are we collecting? And what is currently being done to these records? In other words, after we ingest the files using [Project Electron](https://blog.rockarch.org/am-aspace-integration-update), what still needs to be done to provide access to these records?  
