...
![Bookbag button HTML]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-4.12.01-PM.png)
...
![localStorage]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.05.27-PM.png)

The same script that adds data to localStorage also retrieves it, on request, to create the My List pages.

![My List page]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.04.39-PM.png)
...
![Aeon request form]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.07.27-PM.png)

Let's look at these in some detail.

![Input HTML]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.09.53-PM.png)
...
![Aeon inputs HTML]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.12.42-PM.png)
...
![Aeon Grouping Identifier input]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.12.56-PM.png)
...
![Request modal window]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.18.27-PM.png)
...
![Hidden input HTML]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.18.55-PM.png)

Looking at these more closely, we see three groups of inputs:

![Input groups]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.23.10-PM.png)
...
![Aeon inputs HTML]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.23.21-PM.png)
...
![Submit button html]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-4.20.52-PM.png)
...
![Request in Aeon]({{ site.baseurl }}/assets/img/2015/05/Screen-Shot-2015-05-08-at-12.31.18-PM.png)
