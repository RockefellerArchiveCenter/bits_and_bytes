...
---
We’ve just completed a second round of development on the [Fluxx Exporter](https://github.com/RockefellerArchiveCenter/fluxx_exporter), which sought to address bugs and usability issues we learned about from users. The new version of the application substantially improves ease of installation and configuration and enhances existing functionality in several key areas. Read on for a summary of what we did and what’s next. <!--more-->
...
-	**Enhancing user-facing documentation**: A number of the issues identified during user testing could have been avoided or remediated with better user-facing documentation. We conducted a comprehensive review of user-facing documentation to clarify, add to, and structure documentation.
