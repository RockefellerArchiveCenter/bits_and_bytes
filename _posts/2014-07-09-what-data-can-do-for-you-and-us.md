...
![traffic-sources]({{ site.baseurl }}/assets/img/2014/07/traffic-sources.png)
...
![search-traffic-increase]({{ site.baseurl }}/assets/img/2014/07/search-traffic-increase.png)
...
![pages-and-visit-duration]({{ site.baseurl }}/assets/img/2014/07/pages-and-visit-duration.png)
...
![top-queries]({{ site.baseurl }}/assets/img/2014/07/top-queries.png)

And here you can see the frequency with which these terms were searched over time:

![terms-over-time]({{ site.baseurl }}/assets/img/2014/07/terms-over-time.png)
